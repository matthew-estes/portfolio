...
const EXPAND_NETWORK_PROJECTS = [
  {
    ...
    keyFeatures: [
      ...
      "Organized APIs into 16 categories including Bridges, DEX Aggregators, Derivatives, Lending & Borrowing, NFTs, Oracles, and Yield Aggregators, plus 4 specialized products with advanced filtering by method, chain, and protocol",
      ...
      "Developed WebSocket streaming for real-time data (gas prices, trades, transactions)",
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      "Developed chain-specific parameter routing for 40+ blockchain networks (testnets/mainnets)",
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      "Developed 6-step DeFi workflows for lending, swapping, and cross-chain bridging",
